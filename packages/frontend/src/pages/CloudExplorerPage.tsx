...
function normalizeService(value?: string): CloudServiceType | null {
    const valid: CloudServiceType[] = ['storage', 'k8s', 'database', 'compute', 'networking', 'queue', 'function', 'events', 'observability']
    return valid.includes(value as CloudServiceType) ? (value as CloudServiceType) : null
}
