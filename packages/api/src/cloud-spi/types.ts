...
export type CloudServiceType = 'storage' | 'k8s' | 'database' | 'serverless' | 'compute' | 'networking' | 'queue' | 'function' | 'events' | 'observability'
...
export interface CloudResource {
    ...
    service: CloudServiceType
    type: 'bucket' | 'container' | 'cluster' | 'db-instance' | 'instance' | 'image' | 'vpc' | 'queue' | 'function' | 'topic' | 'log-group'
    region: string | null
